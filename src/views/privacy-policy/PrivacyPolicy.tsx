...
export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of your information when you use playm64.net, and tells you about your privacy rights and how the law protects you.</p>

      <p>By using this website, you agree to the collection and use of information in accordance with this Privacy Policy.</p>

      <h3>Information We Collect</h3>

      <p>Information we collect includes both information you knowingly and actively provide us when using playm64.net, which includes:</p>

      <ul>
        <li>The player alias you provide as a display name for online play</li>
        <li>Emulation save data, which may be shared with other players in netplay sessions</li>
        <li>Keyboard or gamepad inputs that is shared with other players for netplay sessions</li>
        <li>Your email address when contacting us with questions or for support</li>
      </ul>

      <p>Additionally, we automatically gather general information automatically sent by your device, such as your IP address, browser type, and operating system.</p>
      ...
      <p>This site makes use of Google Recaptcha V3 to prevent abuse of our free netplay hosting service. You can read about what data is collected by Google at <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>, and can read the terms of service for Google services at <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>.</p>
      ...
      <p>We keep your personal information only for as long as we need to. This time period may depend on what we are using your information for, in accordance with this privacy policy. If your personal information is no longer required, we will delete it or make it anonymous by removing all details that may identify you. </p>
      ...
      <p>We will share your personal information with third parties only in ways described in this privacy policy. We do not sell your personal information to third parties.</p>

      <p>We may disclose your personal information with courts, tribunals, regulatory authorities, and law enforcement officers, as required by law, in connection with any actual or prospective legal proceedings, or in order to establish, exercise, or defend our legal rights</p>
